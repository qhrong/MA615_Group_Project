...
##Yifeng: getting Celtics and merging data, Celtics EDA, shiny app
...
reduce_data<-complete_data %>% select(Date,AWND,PRCP,SNOW,TMAX,TMIN,TAVG,celtics_attendance)
...
#let us consider if there exist difference between weekday and weekend for attendance
ggplot(reduce_data,aes(x=type,y=celtics_attendance))+geom_point()
